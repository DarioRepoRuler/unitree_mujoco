...
int main(int argc, char **argv)
{
    ...
    try {
        ...
        modelPath = modelPath / "python" / "torchscript_model" / "P20_model.pt";
        // std::filesystem::path modelPath = "/home/dspoljaric/Desktop/unitree_mujoco/example/python/torchscript_model/P_model.pt";
